Webruntime.define('lwc/toDoLWC', ['lwc', 'lightning/configProvider', 'c/toDoItem'], function (lwc, configProvider, _cToDoItem) { 'use strict';

    _cToDoItem = _cToDoItem && Object.prototype.hasOwnProperty.call(_cToDoItem, 'default') ? _cToDoItem['default'] : _cToDoItem;

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".time" + shadowSelector + " {font-size: 4rem;font-weight: 600;}\n.greeting" + shadowSelector + " {font-size: 2rem;font-weight: 400;}\n.container" + shadowSelector + " {background-color: whitesmoke;padding: 16px;max-height: 480px;overflow-y: scroll;display: block;}\n";
    }
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-layout", _lightningLayout, {
        ...
        key: 0
      }, [api_dynamic($cmp.time)])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        },
        key: 3
        ...
        key: 4
      }, [api_text("How's your day today?")])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        classMap: {
        ...
        key: 12
      }, [api_text("To DoS")]), api_iterator($cmp.upcomingTasks, function (todo) {
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-toDoLWC_toDoLWC-host",
      shadowAttribute: "lwc-toDoLWC_toDoLWC"
    };

    class ToDoLWC extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.time = "6.45 PM";
    ...
    lwc.registerDecorators(ToDoLWC, {
      track: {
        time: 1,
        greeting: 1,
        todos: 1
    ...
    var toDoLWC = lwc.registerComponent(ToDoLWC, {
      tmpl: _tmpl$m
    });
