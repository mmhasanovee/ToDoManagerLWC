Webruntime.define('lwc/toDoItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".container" + shadowSelector + " {border: 1px solid grey;padding: .65rem;width: fit-content;border-radius: 8px;margin-top: 8px;margin-left: auto;margin-right: auto;transition: all 5s ease;}\n.completed" + shadowSelector + " {background-color: blue;}\n.upcoming" + shadowSelector + "{background-color: blueviolet;}\n";
    }
    ...
    **/
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 1,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.checkeHandle))
        }
        ...
        key: 2,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.deleteHandle))
        }
      }, [])])];
    }
